 ...
 */
class ShareDisc_Sharing_Platform_Linkedin extends ShareDisc_Sharing_Platform{
	...
	*/
	public function __construct() {
		...
		$this->platform_title = 'LinkedIn';
		$this->platform_version = '1.0.0';
		$this->how_to_url = 'http://www.sharedisc.com/linkedin-app-setup-guide/';
	...
	*/
	public function network_setting(){
		...
		<section class="admin_section">
			<div class="socialicon sd_<?= $this->platform_name; ?>"></div>
			<input class="textfield" type="text" name="sharedisc_<?= $this->platform_name; ?>_app_id" value="<?=$this->platform_options['sharedisc_'.$this->platform_name.'_app_id'];?>"> Your <?= $this->platform_name; ?> Client ID<br />
