(function( $ ) {
	'use strict';
		...
		*/
		 ...
		 * @since 1.0.0
		*/
		function updateDiscountedValues( shareprovider, sharedproductid ){
			jQuery('.woocommerce').prepend('<div class="woocommerce-message">Thank You! ' + ucwords(shareprovider) + 'shared!</div>');
			jQuery('.woocommerce-message').delay(7000).fadeOut('slow',function(){jQuery(this).remove();});		
		}
